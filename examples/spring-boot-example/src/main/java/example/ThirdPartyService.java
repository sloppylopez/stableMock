...
public class ThirdPartyService {
    ...
    public String getFromPostmanEchoWithParams(String startDate, String endDate, String test, String request) {
        // FeignClient uses the URL from app.postmanecho.url property
        // This is set by @DynamicPropertySource in tests to point to WireMock
        return postmanEchoClient.getWithParams(startDate, endDate, test, request);
    }
